  ...
  const handleCameraCapture = () => {
    try {
      if (navigator.mediaDevices) {
        ...
        alert("Kamera tidak tersedia di perangkat atau browser ini. Silakan pilih file gambar sebagai gantinya.");
      ...
      alert("Terjadi kesalahan saat mengakses kamera. Silakan pilih file gambar sebagai gantinya.");
      if (fileInputRef.current) {
        fileInputRef.current.click();
      }
    }
  ...
  return (
    <div className="grid grid-rows-[auto_1fr_auto] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <header className="w-full text-center">
        <h1 className="text-2xl font-bold mb-2">OCR Scanner App</h1>
      ...
      <main className="flex flex-col gap-8 items-center w-full max-w-md">
        <div className="w-full">
          ...
          {text && (
            <div className="border border-gray-200 rounded-lg p-4 mb-6 w-full">
      ...
      <footer className="flex gap-6 flex-wrap items-center justify-center text-sm text-gray-600">
        <p>Made with Tesseract.js</p>
        <p>A Progressive Web App</p>
      </footer>
